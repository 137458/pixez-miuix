...
private fun TopAppBarLayout(
    ...
    // Producer lambdas ¡ª reads stay in layout/draw phases so scroll never recomposes this subtree.
    ...
    // Boolean derivedStateOf invalidates only on flip ¡ú the spring fires once per crossing, not per frame.
